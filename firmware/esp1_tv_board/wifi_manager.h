// =========================================================================
//  wifi_manager.h — multi-network WiFi storage + setup hotspot (ESP8266)
// =========================================================================
...
// hai. Agar koi bhi connect na ho (WIFI_PORTAL_TIMEOUT_MS ke andar), to
// setup hotspot + captive config page apne aap khol deta hai.
void wmBegin();
...
// network se connect nahi ho paaya).
bool wmPortalActive();
