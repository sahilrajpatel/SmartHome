...
static ESP8266WebServer *g_web = nullptr;
...
static void wmStartPortal() {
  ...
  String apName = "SmartHome-Setup-" + String(ESP.getChipId(), HEX);
  WiFi.mode(WIFI_AP);
  ...
  if (!g_web) g_web = new ESP8266WebServer(80);
